...
import { Calendar, Activity, TrendingUp, AlertTriangle, MapPin, Clock, Eye } from 'lucide-react';
...
const TreeDetailModal = ({ tree, isOpen, onClose }) => {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="w-[98%] sm:w-[95%] md:w-[90%] lg:max-w-3xl xl:max-w-4xl max-h-[95vh] sm:max-h-[90vh] overflow-y-auto bg-gradient-to-br from-green-50 via-white to-blue-50 p-4 sm:p-6">
        ...
        <div className="space-y-4 sm:space-y-5 mt-3 sm:mt-4">
              ...
              <div className="flex items-start sm:items-center gap-2 sm:gap-3 w-full sm:w-auto">
                ...
                <div className="min-w-0 flex-1">
                  <h3 className="font-bold text-base sm:text-lg break-words">
                    Black Sigatoka: {tree.blackSigatokaInfection.toUpperCase()}
                  </h3>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4">
            ...
            <div className={`border-2 p-3 sm:p-4 rounded-xl shadow-sm hover:shadow-md transition-shadow ${getYieldBgColor(tree.yieldPrediction)}`}>
              ...
              <p className="text-xs sm:text-sm text-gray-600 mt-1">Expected harvest</p>
            </div>
