...
/* to be configured, mock dataplant has some function included in the main
        ...
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div className="bg-blue-50 p-4 rounded-lg">
              ...
              <p className={`text-2xl font-bold ${getYieldColor(tree.yieldPrediction)}`}>
          ...
          <div className="bg-gray-50 p-4 rounded-lg">
            ...
            <Badge className={`${getStatusColor(tree.blackSigatokaInfection)} text-sm px-3 py-1`}>
          ...
          <div className="grid grid-cols-3 gap-4">
            <div className="text-center p-3 bg-green-50 rounded-lg">
              <div className="text-2xl font-bold text-green-600">
                {Math.floor((Date.now() - new Date(tree.datePlanted)) / (1000 * 60 * 60 * 24))}
              </div>
